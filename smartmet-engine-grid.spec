...
Requires: smartmet-library-grid-content-devel >= 26.9.16
...
- Repackaged due to Fmi::Cache locking changes

* Wed Sep  2 2026 Mika Heiskanen <mika.heiskanen@fmi.fi> - 26.9.2-1.fmi
- Repackaged due to grid-content changes
...
- Added smartmet.engine.grid.contour.threads configuration for band-parallel contouring
